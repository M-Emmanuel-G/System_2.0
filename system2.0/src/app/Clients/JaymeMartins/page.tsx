...
function createPdf() {
   ...
   Segue abaixo o envio da O.S, referente a manutenção preventiva do Escola Jayme Martins!

    Data de envio:  ${dayjs().format("DD-MM-YYYY")}
    Nome do Cliente: Escola Jayme Martins 
    Modelo/Marca do gravador: Yeshi
    Usuario: admin  
    Senha: 
...
//   }
  ...
  // Adiciona título
  doc.setFontSize(22);
  doc.text('Preventiva Escola Jayme Martins', 20, 20);
...
//   doc.addImage(imgData, 'PNG', 20, 80, 50, 50);
  ...
  doc.save('Escola-Jayme-Martins.pdf');
}
   ...
   <main className="w-screen h-screen flex flex-col justify-center itmes-center bg-black text-white">
        ...
        <section className="w-full h-[90%] flex flex-col items-center">
            <section className="w-96 h-full overflow-y-auto justify-center items-center">
                <div className="py-2">
                    <h2 className="text-2xl my-4 text-amber-300">Escola Jayme Martins</h2>
                </div>
