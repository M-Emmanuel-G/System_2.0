...
function createPdf() {
   ...
   Segue abaixo o envio da O.S., referente a manutenção preventiva, de Posto Shell!
    ...
    Modelo/Marca do gravador: MHDX 3116-c
    Usuario: admin  
    Senha: ctts0745
    Total de cameras instaladas: 16 cameras
    IP: 192.168.35.41
        ...
        <section className="w-full h-[90%] flex flex-col items-center">
            <section className="w-96 h-full overflow-y-auto justify-center items-center">
                ...
                <div className="py-2 flex justify-between">
                    ...
                    <span className="mr-4">MHDX 3116-c</span>
                </div>
                <div className="py-2 flex justify-between">
                ...
                <div className="py-2 flex justify-between">
                    <strong>IP:</strong>
                    <span className="mr-4">192.168.35.41</span>
                </div>
                <div className="py-2 flex justify-between">
                ...
                <div className="py-2 flex justify-between">
                    ...
                    <span className="mr-4">EKHH4601977CO</span>
                </div>
                ...
                <div className="py-2 flex justify-between">
                    ...
                    <span className="mr-4">20 dias</span>
                </div>
