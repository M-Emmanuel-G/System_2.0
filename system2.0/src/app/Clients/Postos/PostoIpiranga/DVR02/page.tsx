...
export default function IpirangaPista() {
...
function createPdf() {
  ...
  // Adiciona título
  doc.setFontSize(16);
  doc.text(`Preventiva Posto Ipiranga Pista                                        ${dayjs().format("DD-MM-YYYY")}  `, 20, 40);
...
//   doc.text(dayjs().format("DD-MM-YYYY"), 40, 50);
  ...
  doc.text("Segue abaixo o envio da O.S, referente a manutenção preventiva do Posto Ipiranga Pista!", 20,50)
...
//   doc.text('Página 2', 20, 20);
  ...
  doc.save('Posto-Ipiranga-Pista.pdf');
}
